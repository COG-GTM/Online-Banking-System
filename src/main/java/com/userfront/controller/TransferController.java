...
public class TransferController {
    ...
    public String recipientPost(@ModelAttribute("recipient") Recipient recipient, Principal principal) {
        ...
        if (recipient.getId() != null) {
            Recipient existingRecipient = transactionService.findRecipientById(recipient.getId());
            if (existingRecipient == null || !existingRecipient.getUser().getId().equals(user.getId())) {
