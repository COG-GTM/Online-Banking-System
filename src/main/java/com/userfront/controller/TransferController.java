...
public class TransferController {
    ...
    public String betweenAccountsPost(
        ...
        Optional<BigDecimal> transferAmount = AmountValidator.parse(amount);
        ...
        transactionService.betweenAccountsTransfer(transferFrom, transferTo, transferAmount.get(), primaryAccount, savingsAccount);
    ...
    public String toSomeoneElsePost(@ModelAttribute("recipientName") String recipientName, @ModelAttribute("accountType") String accountType, @ModelAttribute("amount") String amount, Model model, Principal principal) {
        ...
        User user = userService.findByUsername(principal.getName());
        Recipient recipient = transactionService.findRecipientByName(recipientName);
        transactionService.toSomeoneElseTransfer(recipient, accountType, transferAmount.get(), user.getPrimaryAccount(), user.getSavingsAccount());
