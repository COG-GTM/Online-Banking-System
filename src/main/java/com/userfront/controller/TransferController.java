...
public class TransferController {
    ...
    public String recipientPost(@ModelAttribute("recipient") Recipient recipient, Principal principal) {
        ...
        if (recipient.getId() != null) {
            Recipient existingRecipient = transactionService.findRecipientByName(recipient.getName(), principal);
            if (existingRecipient == null || !existingRecipient.getId().equals(recipient.getId())) {
    ...
    public String recipientEdit(@RequestParam(value = "recipientName") String recipientName, Model model, Principal principal){
        ...
        model.addAttribute("recipientList", recipientList);
        model.addAttribute("recipient", recipient == null ? new Recipient() : recipient);
