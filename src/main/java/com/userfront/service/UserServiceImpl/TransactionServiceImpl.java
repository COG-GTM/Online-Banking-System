...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void toSomeoneElseTransfer(Recipient recipient, String accountType, BigDecimal amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws InsufficientFundsException {
    ...
    private void requireSufficientFunds(BigDecimal balance, BigDecimal amount) throws InsufficientFundsException {
        if (balance == null || balance.compareTo(amount) < 0) {
            throw new InsufficientFundsException("Insufficient funds: the account balance does not cover this transfer.");
        }
    }
}
