...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void betweenAccountsTransfer(String transferFrom, String transferTo, BigDecimal amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws Exception {
        BigDecimal transferAmount = AmountValidator.validate(amount);
    ...
    public void toSomeoneElseTransfer(Recipient recipient, String accountType, BigDecimal amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws InvalidAmountException {
        BigDecimal transferAmount = AmountValidator.validate(amount);
