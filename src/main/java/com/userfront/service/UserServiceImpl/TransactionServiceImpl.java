...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void betweenAccountsTransfer(String transferFrom, String transferTo, String amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws Exception {
        BigDecimal transferAmount = DebitValidator.parseAmount(amount);

        if (transferFrom.equalsIgnoreCase("Primary") && transferTo.equalsIgnoreCase("Savings")) {
            DebitValidator.validateSufficientFunds(primaryAccount.getAccountBalance(), transferAmount);
            ...
            DebitValidator.validateSufficientFunds(savingsAccount.getAccountBalance(), transferAmount);
