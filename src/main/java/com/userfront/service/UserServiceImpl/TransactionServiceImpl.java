...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void toSomeoneElseTransfer(Recipient recipient, String accountType, String amount, PrimaryAccount primaryAccount, SavingsAccount savingsAccount) throws InvalidAmountException {
        BigDecimal transferAmount = AmountValidator.parse(amount);
