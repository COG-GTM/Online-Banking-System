...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Recipient findRecipientByNameAndUsername(String recipientName, String username) {
        return recipientDao.findByNameAndUserUsername(recipientName, username);
    }

    public Recipient findRecipientByIdAndUsername(Long id, String username) {
        return recipientDao.findByIdAndUserUsername(id, username);
    }

    @Transactional
    public void deleteRecipientByNameAndUsername(String recipientName, String username) {
