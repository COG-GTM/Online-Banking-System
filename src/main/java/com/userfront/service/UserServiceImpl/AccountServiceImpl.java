...
public class AccountServiceImpl implements AccountService {
    ...
    public PrimaryAccount createPrimaryAccount() {
        ...
        primaryAccount.setAccountBalance(BigDecimal.ZERO.setScale(AmountParser.SCALE));
    ...
    public SavingsAccount createSavingsAccount() {
        ...
        savingsAccount.setAccountBalance(BigDecimal.ZERO.setScale(AmountParser.SCALE));
